...
infotable.innerText="Taille du tableau: "+y+" par "+x
infotable.style.position="fixed"
infotable.style.top="1%"
infotable.style.marginLeft="1%"
infotable.style.fontSize="1em"
document.body.appendChild(infotable)

let infotables=document.createElement("p")
infotables.innerText="Nombe de monstre : "+Math.floor((x * y) / 125)
infotables.style.position="fixed"
infotables.style.top="3%"
infotables.style.marginLeft="1%"
infotables.style.fontSize="1em"
document.body.appendChild(infotables)

let infotables1=document.createElement("p")
infotables1.innerText="Nombe de trésor au depart : "+Math.floor((x * y) / 125)
infotables1.style.position="fixed"
infotables1.style.top="5%"
infotables1.style.marginLeft="1%"
infotables1.style.fontSize="1em"
document.body.appendChild(infotables1)
